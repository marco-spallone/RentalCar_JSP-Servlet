...
<jsp:include page="navbar.jsp">
    <jsp:param name="url1" value="utenteServlet?id=${myid}&action=home"/>
    <jsp:param name="url2" value="autoServlet?isAdmin=${isAdmin}&id=${myid}&action=home"/>
    <jsp:param name="url3" value="utenteServlet?action=profilo&isAdmin=${isAdmin}&id=${myid}"/>
    <jsp:param name="url4" value="prenotazioneServlet?id=${myid}"/>
</jsp:include>
