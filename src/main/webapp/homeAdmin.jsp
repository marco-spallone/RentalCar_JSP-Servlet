    ...
    <div class="row">
        <div class="mx-auto mt-5 col-sm-6">
            ...
            <div class="row"><div class="col-sm-1">
                <a href="aggiungiUtenteServlet"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                </svg></a>
            </div>
            <div class="col-sm-3"></div>
                <div class="col-sm-8">
                    <label for="filtra">Filtra per: </label>
                    <select id="filtra">
                        <option value="nome">Nome</option>
                        <option value="cognome">Cognome</option>
                    </select>
                    <input type="text" placeholder="Filtra..." name="cerca" id="cerca" />
